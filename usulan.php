...
<body>
  <div class="wrap">
    <div class="card">
      <h1>Beri Usulan</h1>
      <p class="small">Sampaikan usulan Anda untuk aplikasi <span class="brand">Mafatihul Akhyar</span>.</p>

      <?php if ($ok): ?>
        <div class="alert ok">Terima kasih! Usulan Anda telah berhasil disimpan.</div>
      <?php elseif ($err): ?>
      ...
      <form class="form" method="post" action="">
        ...
        <div>
          <label for="pesan">Usulan <span class="brand">*</span></label>
          <textarea class="input" id="pesan" name="pesan" placeholder="Tulis usulan Anda..." required></textarea>
        </div>
        <div class="actions">
          <button type="submit" class="btn primary">Kirim Usulan</button>
        </div>
      </form>
      <?php endif; ?>

      <p class="footer-note">Usulan Anda akan disimpan dan digunakan untuk pengembangan selanjutnya.</p>
    </div>
  </div>
</body>
</html>
